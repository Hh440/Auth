    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <div className="relative bg-gray-900 text-white py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <Button className="bg-white text-gray-900 hover:bg-gray-200">Explore Our Clubs</Button>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-bold mb-6">Voices of Our Community</h2>
        ...
        <section className="mb-20">
          <Card className="bg-gray-100">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600 mb-4">Subscribe to our newsletter for the latest updates on club activities, events, and achievements.</p>
